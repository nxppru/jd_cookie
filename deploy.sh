# deploy.sh
apt update -y;apt install wget xz-utils vim curl git -y;
echo -e "set fileencodings=utf-8,ucs-bom,gb18030,gbk,gb2312,cp936\nset termencoding=utf-8\nset encoding=utf-8" > ~/.vimrc
curl -fsSL https://deb.nodesource.com/setup_16.x > setup_16.x; bash setup_16.x; apt-get install -y nodejs
